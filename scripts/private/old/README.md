...
folder `angular-chart-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `angular-chart-snapshots` folder, containing
